...
Real-time temperature monitoring system for intelligent cargo monitoring.

Components:

* [Embedded Software (C++)](https://github.com/MkDev21IA/leitura_sensor_temperatura)
* [Graphical Interface (Python/PyQt6)](https://github.com/MkDev21IA/interface_grafica_sensor_temperatura_analogica)

**Technologies:** STM32 • C++ • Python • PyQt6
